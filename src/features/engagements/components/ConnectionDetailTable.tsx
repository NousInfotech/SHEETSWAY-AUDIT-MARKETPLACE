...
//         {isExpanded ? (
//           <div className='max-h-32 max-w-xs overflow-auto rounded bg-gray-50 p-2 text-xs'>
...
//               <div key={index} className='max-w-xs truncate'>
...
//     headers.some(
//       (header) => typeof row[header] === 'object' && row[header] !== null
//     )
//   );
...
//           <TableHeader>
//             <TableRow>
//               {hasComplexData && <TableHead className='w-10'></TableHead>}
//               {headers.map((header) => (
...
//                 <TableRow
//                   className={expandedRows.has(rowIndex) ? 'bg-gray-50' : ''}
//                 >
//                   {hasComplexData && (
...
//   const stringValue = String(value); // Directly convert value to string for display
//   const isLong = stringValue.length > maxLength;
//   const [showFull, setShowFull] = useState(false);
...
//           </TableHeader>
//           <TableBody>
//             {flattenedRows.map((rowWrapper, rowIndex) => (
//               <React.Fragment key={rowIndex}>
//                 <TableRow
//                   className={expandedRows.has(rowIndex) ? 'bg-gray-50' : ''}
//                 >
...
//                           className='h-6 w-6 p-0'
//                           onClick={() => toggleRowExpansion(rowIndex)}
//                           title={expandedRows.has(rowIndex) ? 'Collapse details' : 'Expand details'}
//                         >
//                           {expandedRows.has(rowIndex) ? (
//                             <ChevronDown className='h-4 w-4' />
//                           ) : (
